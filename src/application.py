    ...
    def load_images(self):
        ...
        for character_number in range(1, 16):
            for character_level in range(1, 4):
                ...
                self.image[
                    f'character_illust_{str(character_number).zfill(2)}_lv{character_level}'] = pygame.image.load(
                    IMAGE_PATH + f"/character_illust/character_{str(character_number).zfill(2)}{lv_string}.png")
        self.image['bg-stage2'] = pygame.image.load(IMAGE_PATH + "/background/02.png")
        self.image['logo'] = pygame.image.load(IMAGE_PATH + "/logo.png")

    def load_audios(self):
        self.audio['bgm_waiting'] = pygame.mixer.Sound("resources/audios/bgm_waiting.mp3")
        self.audio['bgm_acuarium'] = pygame.mixer.Sound("resources/audios/bgm_acuarium.mp3")
        self.audio['bgm_fortress_sky'] = pygame.mixer.Sound("resources/audios/bgm_fortress_sky.mp3")
